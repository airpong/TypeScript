...
class Block {
  ...
  static calculateBlockHash = (index: number, previousHash: string, timestamp: number, data: string): string => CrypoJS.SHA256(index + previousHash + timestamp + data).toString()
